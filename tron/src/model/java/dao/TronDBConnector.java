...
public final class TronDBConnector {


    /** The instance. */
    private static TronDBConnector instance;
     ...
     */
    public static TronDBConnector getInstance() {
        if (instance == null) {
            setInstance(new TronDBConnector());
        }
        return instance;
    }
     ...
     *            the new instance
     */
    private static void setInstance(final TronDBConnector instance) {
    	TronDBConnector.instance = instance;
    }
    ...
    private boolean open() {
        try {
            this.connection = DriverManager.getConnection(TronDBConnector.url, TronDBConnector.user,
            		TronDBConnector.password);
